...
const AgentRunBoardRow = z
  .object({
    ...
    liquid_contract_expiry: z.union([z.string(), z.null()]),
    intl_change_pct: z.union([z.number(), z.null()]),
    usdinr_change_pct: z.union([z.number(), z.null()]),
    implied_open_span_days: z.union([z.number(), z.null()]),
    implied_open_span_label: z.union([z.string(), z.null()]),
    intl_span_days: z.union([z.number(), z.null()]),
    intl_span_label: z.union([z.string(), z.null()]),
    usdinr_span_days: z.union([z.number(), z.null()]),
    usdinr_span_label: z.union([z.string(), z.null()]),
    ...
    import_duty: z.union([z.number(), z.null()]),
